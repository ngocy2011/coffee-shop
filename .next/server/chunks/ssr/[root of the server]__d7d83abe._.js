...
"[project]/src/ai/flows/coffee-shop-suggestion.ts [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
/* __next_internal_action_entry_do_not_use__ {"4080d9f6075054c847bff94aa88f292d6277ac0bb7":"suggestCoffeeShop"} */ __turbopack_context__.s({
    "suggestCoffeeShop": (()=>suggestCoffeeShop)
});
...
/**
 * @fileOverview Coffee shop suggestion flow based on user's purpose.
 *
 * - suggestCoffeeShop - A function that suggests coffee shops based on user's purpose.
 * - CoffeeShopSuggestionInput - The input type for the suggestCoffeeShop function.
 * - CoffeeShopSuggestionOutput - The return type for the suggestCoffeeShop function.
...
;
;
const CoffeeShopSuggestionInputSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    purpose: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().describe('The purpose of the coffee shop visit (dating, learning, working, etc.).')
});
const CoffeeShopSuggestionOutputSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    coffeeShopSuggestion: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().describe('A coffee shop suggestion based on the user provided purpose.')
});
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ suggestCoffeeShop(input) {
    return suggestCoffeeShopFlow(input);
}
const prompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$genkit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ai"].definePrompt({
    name: 'coffeeShopSuggestionPrompt',
    input: {
        schema: CoffeeShopSuggestionInputSchema
    },
    output: {
        schema: CoffeeShopSuggestionOutputSchema
    },
    prompt: `You are a coffee shop expert. You suggest coffee shops based on the user's stated purpose. Be very brief.

Purpose: {{{purpose}}}`
});
const suggestCoffeeShopFlow = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$genkit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ai"].defineFlow({
    name: 'suggestCoffeeShopFlow',
    inputSchema: CoffeeShopSuggestionInputSchema,
    outputSchema: CoffeeShopSuggestionOutputSchema
}, async (input)=>{
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(suggestCoffeeShop, "4080d9f6075054c847bff94aa88f292d6277ac0bb7", null);
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/build/webpack/loaders/next-flight-loader/server-reference.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$app$2d$render$2f$encryption$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/server/app-render/encryption.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$coffee$2d$shop$2d$suggestion$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/ai/flows/coffee-shop-suggestion.ts [app-rsc] (ecmascript)");
...
;
;
const SuggestionFormSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    purpose: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(3, {
        message: "Purpose must be at least 3 characters long."
    }).max(100)
});
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getCoffeeShopSuggestion(prevState, formData) {
    ...
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$coffee$2d$shop$2d$suggestion$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["suggestCoffeeShop"])(input);
        return {
            message: 'Suggestion received!',
            suggestion: result.coffeeShopSuggestion,
            success: true
        };
    } catch (error) {
        console.error('Error getting coffee shop suggestion:', error);
        return {
            message: 'Failed to get suggestion from AI. Please try again.',
            success: false
        };
    }
}
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCoffeeShopSuggestion, "6018964fdf3f6833bd621ad0c028a86916df5beb27", null);
}}),
...
{
__turbopack_context__.s({
    "6018964fdf3f6833bd621ad0c028a86916df5beb27": (()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCoffeeShopSuggestion"])
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/actions.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.next-internal/server/app/page/actions.js { ACTIONS_MODULE0 => "[project]/src/lib/actions.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
}}),
...
{
__turbopack_context__.s({
    "6018964fdf3f6833bd621ad0c028a86916df5beb27": (()=>__TURBOPACK__imported__module__$5b$project$5d2f2e$next$2d$internal$2f$server$2f$app$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$exports$3e$__["6018964fdf3f6833bd621ad0c028a86916df5beb27"])
});
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d7d83abe._.js.map